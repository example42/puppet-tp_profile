...
#   automatically added.
#   tp_profile::docker::auto_conf: true
#
...
#   Check tp_profile::docker::resources_auto_conf_hash in
...
#   Check tp_profile::docker::options_auto_conf_hash in
#   data/common/docker.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::docker::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('tp_profile::docker::options', Hash, $options_lookup_method, {})

  if $manage {
    if $no_noop {
      info('Forced no-noop mode in tp_profile::docker')
      noop(false)
    }
    ...
    # Declaration of tp_profile::docker::resources
    $resources=lookup('tp_profile::docker::resources', Hash, $resources_lookup_method, {})
