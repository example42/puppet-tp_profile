...
#   tp_profile::docker::resources_hash:
#     tp::conf:
#       docker:
...
#   Check tp_profile::docker::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::docker::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
