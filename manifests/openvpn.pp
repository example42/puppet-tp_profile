...
#   Check tp_profile::openvpn::resources_auto_conf_hash in
...
#   Check tp_profile::openvpn::options_auto_conf_hash in
#   data/common/openvpn.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::openvpn::resources
...
#  Hash               $options                 = {},
  ...
  if $manage {
    ...
    # Declaration of tp_profile::openvpn::resources
    $resources=lookup('tp_profile::openvpn::resources', Hash, $resources_lookup_method, {})
