...
#   tp_profile::puppet::resources_hash:
#     tp::conf:
#       puppet:
...
#   Check tp_profile::puppet::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::puppet::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
