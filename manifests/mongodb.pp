...
#   tp_profile::mongodb::resources_hash:
#     tp::conf:
#       mongodb:
...
# @param resources_hash An hash of tp::conf and tp::dir resources for mongodb.
...
#   Check tp_profile::mongodb::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::mongodb::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
