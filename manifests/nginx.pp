...
#   tp_profile::nginx::resources_hash:
#     tp::conf:
#       nginx:
...
#   Check tp_profile::nginx::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::nginx::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
