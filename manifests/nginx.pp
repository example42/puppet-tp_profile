...
#   automatically added.
#   tp_profile::nginx::auto_conf: true
#
...
#   Check tp_profile::nginx::resources_auto_conf_hash in
...
#   Check tp_profile::nginx::options_auto_conf_hash in
#   data/common/nginx.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::nginx::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('tp_profile::nginx::options', Hash, $options_lookup_method, {})

  if $manage {
    if $no_noop {
      info('Forced no-noop mode in tp_profile::nginx')
      noop(false)
    }
    ...
    # Declaration of tp_profile::nginx::resources
    $resources=lookup('tp_profile::nginx::resources', Hash, $resources_lookup_method, {})
