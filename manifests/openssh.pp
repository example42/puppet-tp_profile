...
#   tp_profile::openssh::resources_hash:
#     tp::conf:
#       openssh:
...
#   Check tp_profile::openssh::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::openssh::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
