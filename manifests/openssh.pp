...
#         creates: '/opt/openssh'
#   tp_profile::openssh::options_hash:
#     key: value
#
...
#   automatically added.
#   tp_profile::openssh::auto_conf: true
#
...
#   Check tp_profile::openssh::resources_auto_conf_hash in
...
#   Check tp_profile::openssh::options_auto_conf_hash in
#   data/common/openssh.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::openssh::resources
...
#  Hash               $resources                = {},
  ...
  if $manage {
    if $no_noop {
      info('Forced no-noop mode in tp_profile::openssh')
      noop(false)
    }
    ...
    # Declaration of tp_profile::openssh::resources
    $resources=lookup('tp_profile::openssh::resources, Hash, $resources_lookup_method, {})
