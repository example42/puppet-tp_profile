...
#   Check tp_profile::mysql::resources_auto_conf_hash in
...
#   Check tp_profile::mysql::options_auto_conf_hash in
#   data/common/mysql.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::mysql::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('tp_profile::mysql::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of tp_profile::mysql::resources
    $resources=lookup('tp_profile::mysql::resources', Hash, $resources_lookup_method, {})
