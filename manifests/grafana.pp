...
#   tp_profile::grafana::resources_hash:
#     tp::conf:
#       grafana:
...
#   Check tp_profile::grafana::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::grafana::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
