...
#   Check tp_profile::mariadb::resources_auto_conf_hash in
...
#   Check tp_profile::mariadb::options_auto_conf_hash in
#   data/common/mariadb.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::mariadb::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('tp_profile::mariadb::options', Hash, $options_lookup_method, {})
  ...
  if $manage {
    ...
    # Declaration of tp_profile::mariadb::resources
    $resources=lookup('tp_profile::mariadb::resources', Hash, $resources_lookup_method, {})
