...
#   Check tp_profile::php::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::php::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
