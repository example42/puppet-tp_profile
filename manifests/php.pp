# tp_profile::php
#
# @summary This tp profile manages php with Tiny Puppet (tp)
#
...
#   tp_profile::php::upstream_repo: true
#
# @example Manage extra configs via hiera (yaml) with templates based on custom options
#   tp_profile::php::ensure: present
#   tp_profile::php::resources:
#     tp::conf:
#       php:
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::php::resources
...
#  Hash               $resources                = {},
  ...
  if $manage {
    ...
    # Declaration of tp_profile::php::resources
    $resources=lookup('tp_profile::php::resources, Hash, $resources_lookup_method, {})
