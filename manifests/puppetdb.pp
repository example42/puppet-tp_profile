# tp_profile::puppetdb
#
# @summary This tp profile manages puppetdb with Tiny Puppet (tp)
#
...
#   automatically added.
#   tp_profile::puppetdb::auto_conf: true
#
...
#   Check tp_profile::puppetdb::resources_auto_conf_hash in
...
#   Check tp_profile::puppetdb::options_auto_conf_hash in
#   data/common/puppetdb.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::puppetdb::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('tp_profile::puppetdb::options', Hash, $options_lookup_method, {})

  if $manage {
    if $no_noop {
      info('Forced no-noop mode in tp_profile::puppetdb')
      noop(false)
    }
    ...
    # Declaration of tp_profile::puppetdb::resources
    $resources=lookup('tp_profile::puppetdb::resources', Hash, $resources_lookup_method, {})
