...
#   tp_profile::puppetdb::resources_hash:
#     tp::conf:
#       puppetdb:
...
#   Check tp_profile::puppetdb::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::puppetdb::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
