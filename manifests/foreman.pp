...
#   tp_profile::foreman::resources_hash:
#     tp::conf:
#       foreman:
...
#   Check tp_profile::foreman::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::foreman::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
