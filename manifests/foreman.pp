...
#   automatically added.
#   tp_profile::foreman::auto_conf: true
#
...
#   Check tp_profile::foreman::resources_auto_conf_hash in
...
#   Check tp_profile::foreman::options_auto_conf_hash in
#   data/common/foreman.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::foreman::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('tp_profile::foreman::options', Hash, $options_lookup_method, {})

  if $manage {
    if $no_noop {
      info('Forced no-noop mode in tp_profile::foreman')
      noop(false)
    }
    ...
    # Declaration of tp_profile::foreman::resources
    $resources=lookup('tp_profile::foreman::resources', Hash, $resources_lookup_method, {})
