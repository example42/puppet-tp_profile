...
#   tp_profile::postgresql::resources_hash:
#     tp::conf:
#       postgresql:
...
#   Check tp_profile::postgresql::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::postgresql::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
