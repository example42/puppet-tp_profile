...
#   automatically added.
#   tp_profile::postgresql::auto_conf: true
#
...
#   Check tp_profile::postgresql::resources_auto_conf_hash in
...
#   Check tp_profile::postgresql::options_auto_conf_hash in
#   data/common/postgresql.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::postgresql::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('tp_profile::postgresql::options', Hash, $options_lookup_method, {})

  if $manage {
    if $no_noop {
      info('Forced no-noop mode in tp_profile::postgresql')
      noop(false)
    }
    ...
    # Declaration of tp_profile::postgresql::resources
    $resources=lookup('tp_profile::postgresql::resources', Hash, $resources_lookup_method, {})
