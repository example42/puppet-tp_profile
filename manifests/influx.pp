...
#   tp_profile::influx::resources_hash:
#     tp::conf:
#       influx:
...
#         base_dir: conf
#   tp_profile::influx::options_hash:
#     key: value
#
...
# @param resources_hash An hash of tp::conf and tp::dir resources for influx.
...
#   Check tp_profile::influx::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::influx::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
