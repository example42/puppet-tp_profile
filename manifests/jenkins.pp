...
#   tp_profile::jenkins::resources_hash:
#     tp::conf:
#       jenkins:
...
#   Check tp_profile::jenkins::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::jenkins::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
