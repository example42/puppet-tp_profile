...
#   tp_profile::puppetserver::options:
#     key: value
#
...
#   automatically added.
#   tp_profile::puppetserver::auto_conf: true
#
...
#   Check tp_profile::puppetserver::resources_auto_conf_hash in
...
#   Check tp_profile::puppetserver::options_auto_conf_hash in
#   data/common/puppetserver.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::puppetserver::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('tp_profile::puppetserver::options', Hash, $options_lookup_method, {})

  if $manage {
    if $no_noop {
      info('Forced no-noop mode in tp_profile::puppetserver')
      noop(false)
    }
    ...
    # Declaration of tp_profile::puppetserver::resources
    $resources=lookup('tp_profile::puppetserver::resources', Hash, $resources_lookup_method, {})
