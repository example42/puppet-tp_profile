...
#   tp_profile::puppetserver::resources_hash:
#     tp::conf:
#       puppetserver:
...
#   Check tp_profile::puppetserver::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::puppetserver::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
