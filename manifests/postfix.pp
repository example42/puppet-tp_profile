...
#   tp_profile::postfix::resources_hash:
#     tp::conf:
#       postfix:
...
#         base_dir: conf
#   tp_profile::postfix::options_hash:
#     key: value
#
...
#   Check tp_profile::postfix::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::postfix::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
...
class tp_profile::postfix (
  ...
  if $manage {
    if $no_noop {
      info('Forced no-noop mode in tp_profile::postfix')
      noop(false)
    }
