...
#   tp_profile::influxdb::upstream_repo: true
#
# @example Manage extra configs via hiera (yaml) with templates based on custom options
#   tp_profile::influxdb::ensure: present
#   tp_profile::influxdb::resources:
#     tp::conf:
#       influxdb:
...
#   automatically added.
#   tp_profile::influxdb::auto_conf: true
#
...
#   Check tp_profile::influxdb::resources_auto_conf_hash in
...
#   Check tp_profile::influxdb::options_auto_conf_hash in
#   data/common/influxdb.yaml for the auto_conf defaults.
#
...
#   parameter.
# @param resource_lookup_method What lookup method to use for tp_profile::influxdb::resources
...
#  Hash               $options                 = {},
  ...
  $options=lookup('tp_profile::influxdb::options', Hash, $options_lookup_method, {})

  if $manage {
    if $no_noop {
      info('Forced no-noop mode in tp_profile::influxdb')
      noop(false)
    }
    ...
    # Declaration of tp_profile::influxdb::resources
    $resources=lookup('tp_profile::influxdb::resources', Hash, $resources_lookup_method, {})
