...
#   tp_profile::openswan::resources_hash:
#     tp::conf:
#       openswan:
...
#   Check tp_profile::openswan::resources_auto_conf_hash in data/$auto_conf/*.yaml for
...
#   Check tp_profile::openswan::options_auto_conf_hash in data/$auto_conf/*.yaml for
#   the auto_conf defaults.
